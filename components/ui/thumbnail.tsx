...
export const ImageThumbnail = ({ src, alt, label, onClick }: { src: string; alt: string; label: string; onClick: () => void }) => (
  <div className="group relative cursor-pointer overflow-hidden rounded-xl border border-slate-200 bg-slate-50 aspect-video md:aspect-4/3" onClick={onClick}>
    ...
    <Image src={src} alt={alt} fill className="object-cover transition-transform duration-500 group-hover:scale-105" sizes="(max-width: 768px) 100vw, 300px" unoptimized />
