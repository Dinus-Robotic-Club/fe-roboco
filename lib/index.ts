...
export const nav_admin = {
  left: [
    { title: 'Turnamen', href: '/admin/dashboard' }, //buat liat list turnamen yang ada
    { title: 'Pertandingan', href: '/admin/match' }, // nanti bakal masuk ke (/match) buat get all match
    { title: 'Kehadiran', href: '/admin/checking-ticket' }, //buat check ticket
  ],
  right: [
    { title: 'Bracket', href: '#' }, //buat liat bracket playoff yang ada (/bracket)
    { title: 'Papan liga', href: '/leagueboard' }, // buat liat klasemen yang ada (leagueboard)
    { title: 'Keluar', href: '/auth/login' },
  ],
}
