import { ICardMatchResp } from '@/component/ui/CardMatch'
...
export const getAllMatchHistoryById = (): Promise<IApiResponse<unknown>> => {
    return apiFetch<IApiResponse<unknown>>(`${BASE}/api/matches/team/history`, {
        method: 'GET',
    })
}
