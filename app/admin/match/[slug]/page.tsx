...
function MatchControl() {
  ...
  const scoreActions = [
    ...
    { name: "Foul", type: "foul", icon: <RiTriangularFlagLine className="w-8 h-8" /> },
      ...
      <main className="w-full p-4 md:p-6 mb-20">
        ...
        <div className="w-full py-6 px-3 flex-col items-center justify-between rounded-md bg-white shadow-[0_-2px_1px_rgba(0,0,0,0.05),0_4px_9px_rgba(0,0,0,0.1)] lg:bg-transparent lg:shadow-none font-plus-jakarta-sans">
          ...
          <div className="w-full flex lg:flex-col items-center justify-between">
            <div className="flex flex-col gap-6 lg:gap-0 lg:flex-row items-start justify-center lg:w-full lg:max-w-6x md:px-3">
              {/* Home Team */}
              ...
              <div className="hidden lg:flex flex-col items-center col-span-1 gap-2">
        ...
        {showModalStart ? (
          <ValidationModal
            ...
            desc="Hitungan mundur akan dimulai jika mulai memilih Mulai."
            confirm_text="Mulai"
          />
        ) : null}
        {showModalFinish ? (
