      ...
      >
        ...
        <div className="flex flex-col gap-4 items-center ">
          <div className="flex flex-wrap justify-between items-center gap-3 w-full">
            ...
            <label className="flex flex-col items-center justify-center aspect-square w-full max-w-[330px] md:max-w-[350px] 2xl:max-w-[400px] border-2 border-dashed border-gray-400 rounded-lg mx-auto">
              {preview ? (
                <Image
                  src={preview}
                  width={400}
          ...
          <div className="flex w-full flex-wrap justify-between items-center gap-3">
            ...
            <button
              disabled={!preview}
              className="py-3 px-7 text-xs sm:text-sm bg-yellow-300 font-semibold rounded  flex items-center justify-center gap-2 disabled:bg-yellow-300/50 disabled:cursor-not-allowed disabled:text-gray-500 hover:bg-amber-300/80 cursor-pointer w-full sm:w-fit"
            >
