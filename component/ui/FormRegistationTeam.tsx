	...
	return (
		<div className=" z-10  w-full">
			<div className=" flex flex-col justify-center  items-center gap-10 sm:gap-10 lg:mt-4">
				<h1 className="text-center font-bold text-xl sm:text-2xl font-plus-jakarta-sans">
					PROFIL TIM
				</h1>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-y-7 sm:gap-y-7 gap-x-4 sm:gap-x-6 w-full h-full">
					<div className="flex flex-col gap-1">
						<label
							htmlFor="team_name"
							className="text-sm lg:text-base font-fira-code"
						>
							NAMA TIM
						</label>
						<input
					...
					<div className="flex flex-col gap-1">
						<label
							htmlFor="team_logo"
							className="text-sm lg:text-base font-fira-code tracking-wide"
						>
							LOGO TIM (OPSIONAL)
						</label>
						...
						>
							<span
								className={`text-gray-400 font-plus-jakarta-sans text-sm lg:text-base ${
									data.logo ? 'text-gray-800' : ''
								}`}
							>
						...
						{error?.logo && (
							<p className="text-red-500 text-xs">{error.logo}</p>
						)}
					</div>
					...
					<div className="flex flex-col gap-1">
						...
						{error?.invoice && (
							<p className="text-red-500 text-xs">{error.invoice}</p>
						)}
					</div>
