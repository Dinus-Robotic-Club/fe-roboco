...
function Sponsorship() {
    return (
        <section className="flex flex-col h-auto w-full items-center justify-center font-plus-jakarta-sans gap-16" id="sponsor">
            ...
            <div className="flex flex-col items-center justify-center w-full h-auto gap-10">
                ...
                <div className="relative w-full overflow-hidden">
                    <Marquee className="min-w-full" gradient>
                        {logos.map((logo, i) => (
                            <Image key={i} src={logo} width={120} height={120} alt="media partner" className="w-20 md:w-24 2xl:w-32 shrink-0 mx-5 md:mx-10" />
                        ))}
                        {logos.map((logo, i) => (
                            <Image key={i} src={logo} width={120} height={120} alt="media partner" className="w-20 md:w-24 2xl:w-32 shrink-0 mx-5 md:mx-10" />
                        ))}
