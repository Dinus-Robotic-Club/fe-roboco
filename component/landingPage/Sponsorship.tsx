...
function Sponsorship() {
  return (
    <section className="flex flex-col h-auto w-full items-center justify-center font-plus-jakarta-sans gap-16">
          ...
          <Marquee className="min-w-full" gradient>
            {logos.map((logo, i) => (
              <Image
                ...
                height={120}
                alt="media partner"
                className="w-20 md:w-24 2xl:w-32 shrink-0 mx-5 md:mx-10"
              />
            ))}
            {logos.map((logo, i) => (
              <Image
