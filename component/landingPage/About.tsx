        ...
        <div className="flex flex-col 2xl:flex-row gap-6 2xl:gap-8  justify-center items-center max-w-[1500px] w-full">
          <div className="flex flex-col sm:flex-row items-center gap-4 lg:gap-6">
            ...
            <Image
              ...
              width={10}
              height={90}
              className="hidden 2xl:block w-1 h-16 lg:h-20 rotate-90 sm:rotate-0"
            />
          </div>

          <div className="flex-1 max-w-2xl">
            <p className="text-lg sm:text-xl lg:text-2xl font-plus-jakarta-sans text-center 2xl:text-left leading-relaxed">
              dalam DN Roboco 2026, kami memberikan ruang untuk peserta beradu teknologi dalam 2 kategori perlombaan kami, yaitu
              robot soccer dan robot summo
            </p>
          </div>
        </div>
      </div>
