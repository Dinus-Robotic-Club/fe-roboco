      ...
      <div className="min-h-[400px] lg:min-h-[450px] w-full flex flex-col justify-center items-center mt-10 md:mt-0 py-5 px-4 sm:px-6 lg:px-8 ">
        <div className="flex flex-col gap-6 2xl:gap-8 justify-center items-center max-w-[1500px] w-full">
          ...
          <motion.div
            ...
            className="flex-1 max-w-5xl 2xl:max-w-7xl"
          >
            <p className="text-lg sm:text-xl lg:text-2xl font-plus-jakarta-sans text-center leading-relaxed w-full">
              DN Roboco 2026 hadir mewadahi inovator dan pecinta robotika Indonesia! Bersainglah dalam dua kategori seru Robot
              Soccer dan Robot Summo. Ini adalah ajang pertandingan intelektualitas dan ketangkasan teknik, di mana setiap sirkuit
              dan kode diuji di medan pertandingan sesungguhnya. Siapkan robot terbaikmu dan buktikan siapa yang paling tangguh!
            </p>
          </motion.div>
        </div>
      </div>
